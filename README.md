...
一款面向小朋友的中英文单词语音查询应用。点一下圆形按钮开始听，说出中文词语（或英文单词），再点一下按钮开始识别，即可显示对应的英文单词、中文释义，并自动朗读单词发音和逐字母拼写（如 apple → A-P-P-L-E）。点击单词可重复朗读拼写。
...
- 点击开始/停止：点一下按钮开始听，再点一下开始识别（说出中文或英文均可）
